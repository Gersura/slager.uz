...
const PROJECT_TITLE_LINES = {
  "click-admins": ["Click Admins: как Excel-хаос превратился", "в рабочую систему"],
  "smartbank-retention-activation": [
    "SmartBank Business: как я вытащил продукт",
    "из почти нулевого retention",
  ],
}
...
const ProjectTitle = ({ project }) => {
  const customLines = PROJECT_TITLE_LINES[project.slug]
...
export const getStaticProps = async ({ params }) => {
  return {
    props: {
      project: getProjectContent(params.slug, "ru"),
